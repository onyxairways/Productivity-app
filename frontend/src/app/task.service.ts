...
export class TaskService {
    ...
    getQuestions(id: number): Observable<{ questions: string[] }> {
        return this.http.post<{ questions: string[] }>(`${this.apiUrl}/tasks/${id}/questions`, {});
    }

    suggestDescription(id: number, answers: string[]): Observable<{ suggestion: string }> {
        return this.http.post<{ suggestion: string }>(`${this.apiUrl}/tasks/${id}/suggest`, { answers });
    }
